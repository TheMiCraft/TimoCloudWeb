...
public class HomeServlet extends HttpServlet {
    ...
    private String getBases(){
        ...
        for (BaseObject base : TimoCloudAPI.getUniversalAPI().getBases()) {
            stringBuilder.append("<li class=\"menu-item\"><a href=\"/base?base=").append(base.getId()).append("\"><span class=\"menu-title\">").append(base.getName()).append("</span></a></li>");
        }
    ...
    private String getProxys(){
        ...
        for (ProxyGroupObject proxy : TimoCloudAPI.getUniversalAPI().getProxyGroups()) {
            stringBuilder.append("<li class=\"menu-item\"><a href=\"/proxyGroup?proxyGroup=").append(proxy.getId()).append("\"><span class=\"menu-title\">").append(proxy.getName()).append("</span></a></li>");
        }
        return stringBuilder.toString();
    }
