...
public class LoginServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String html = new BufferedReader(new InputStreamReader(HTMLParser.class.getResourceAsStream("/login.html"), StandardCharsets.UTF_8)).lines().collect(Collectors.joining());
...
//        response.getWriter().println("background-color: #32414d;");
...
//        response.getWriter().println("</html>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if (Objects.equals(TimoCloudWeb.getInstance().getConfigManager().getString("user_" + username),
                    toHexString(MessageDigest.getInstance("SHA-256").digest(password.getBytes(StandardCharsets.UTF_8))))) {
