...
public class HTMLParser {
    ...
    private static String getReplace(){
        ...
        finalstring.append("<li class=\"menu-item\"><a href=\"/home\"> <span class=\"menu-icon\"> <i class=\"fa-solid fa-house\"></i> </span> <span class=\"menu-title\">Home</span></a></li>");
        finalstring.append("<li class=\"menu-item sub-menu\"> <a href=\"#\"> <span class=\"menu-icon\"> <i class=\"fa-solid fa-computer\"></i> </span> <span class=\"menu-title\">Bases</span> </a><div class=\"sub-menu-list\"><ul>");
        ...
        finalstring.append("<li class=\"menu-item sub-menu\"> <a href=\"#\"> <span class=\"menu-icon\"> <i class=\"fa-solid fa-server\"></i> </span> <span class=\"menu-title\">Server-Groups</span> </a><div class=\"sub-menu-list\"><ul>");
        ...
        finalstring.append("</ul></div>");
        finalstring.append("<li class=\"menu-item sub-menu\"> <a href=\"#\"> <span class=\"menu-icon\"> <i class=\"fa-solid fa-network-wired\"></i> </span> <span class=\"menu-title\">Proxy-Groups</span> </a><div class=\"sub-menu-list\"><ul>");
